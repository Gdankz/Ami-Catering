...
<body class="bg-[#FFFFFF] min-h-screen flex flex-col">
    ...
    <main class="flex flex-col items-center mt-10">
        <div class="w-2/3 bg-white rounded-lg shadow p-8 border border-gray-200 relative">
            ...
            <button id="tambahfoto" class="absolute top-4 right-4 flex items-center">
                <img src="..\images\tombolAdd.png" alt="Add" class="btn-image w-8 h-8 rounded">
            </button>
            ...
            <div class="flex space-x-8 mt-8">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="flex items-center space-x-2 mt-2">
                      <img src="..\images\pencil.png" alt="edit" class="w-3 h-3">
                      <img src="..\images\hapus.png" alt="delete" class="w-4 h-4">
                  </div>
                ...
                <div class="space-y-4 w-full">
                    ...
                    <input type="text" placeholder="NIK" class="w-full border-b border-gray-300 focus:outline-none focus:border-green-500 font-bold">
                </div>
            </div>
        </div>
    </main>
